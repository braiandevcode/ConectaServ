    ...
    <>
      <div className='c-flex c-flex-column gap-1 form-basic__fields'>
        ...
        <div className='c-flex c-flex-column gap-1/2 form-basic__field'>
          ...
          <input type='password' id='confirmPassword' autoComplete='confirmPassword' className={`form-basic__input ${interactedConfirmPassword && styleBorderFieldError(formState, 'confirmPassword')}`} aria-label='Confirmar contrasena' placeholder='***********' value={confirmPassword} onInput={handleConfirmPassword} required />
