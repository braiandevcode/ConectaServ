...
import FieldBaseDto from "../../modules/fields/dto/FieldBaseDto.js";
...
export default class FormFieldFactory {
  public static createFieldForm<T extends TTypeField>(typeField: T, options: TFieldOptionsMap[T]): TFieldConcreteMap[T] {
    switch (typeField) {
      case "select":
        const optionsSelect = new FieldBaseDto<string, iSelectFieldOptions>(options as iSelectFieldOptions); // CASTEAR ASEGURANDO SU TIPO DE INTERFACE
      ...
      case "input":
        const optionsInput = new FieldBaseDto<string, iInputFieldOptions>(options as iInputFieldOptions); // CASTEAR ASEGURANDO SU TIPO DE INTERFACE
      ...
      case "file":
        const optionsInputFile = new FieldBaseDto<FileList, iInputFileOptions>(options as iInputFileOptions); // CASTEAR ASEGURANDO SU TIPO DE INTERFACE
      ...
      case "textArea":
        const optionsTextAreaField = new FieldBaseDto<string, iTextAreaFieldOptions>(options as iTextAreaFieldOptions); // CASTEAR ASEGURANDO SU TIPO DE INTERFACE
      ...
      case "inputCheck":
        const optionsFieldCheck = new FieldBaseDto<string, iInputFieldCheckOptions>(options as iInputFieldCheckOptions); // CASTEAR ASEGURANDO SU TIPO DE INTERFACE
