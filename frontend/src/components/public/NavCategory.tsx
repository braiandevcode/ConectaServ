        ...
        <div className={`dropdown ${dropdownOpen ? 'open' : ''}`}>
          ...
          <div className='dropdown__menu'>
            ...
            <div className='dropdown__group'>
              ...
              <Link to='/services?service=corte-pasto' className='dropdown__item' onClick={closeDropdown}>
                Corte de pasto
              </Link>
              <Link to='/services?service=poda-arboles' className='dropdown__item' onClick={closeDropdown}>
                Poda de árboles
              </Link>
              <Link to='/services?service=poda-arbustos' className='dropdown__item' onClick={closeDropdown}>
                Poda de arbustos
              </Link>
              <Link to='/services?service=desmalezado' className='dropdown__item' onClick={closeDropdown}>
                Desmalezado
              </Link>
              <Link to='/services?service=limpieza-jardin' className='dropdown__item' onClick={closeDropdown}>
                Limpieza de jardín
              </Link>
            ...
            <div className='dropdown__group'>
              ...
              <Link to='/services?service=transporte-muebles' className='dropdown__item' onClick={closeDropdown}>
                Transporte de muebles
              </Link>
              <Link to='/services?service=transporte-electrodomesticos' className='dropdown__item' onClick={closeDropdown}>
