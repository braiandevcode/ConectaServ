...
export const styleBorderFieldError = <T extends iFormStateLogin | iFormStateValidationIdentifyEmail | iFormValidationVerifyEmail | iFormStateValidationTask | iFormStateValidationClient>(formState: T, fieldName: keyof T): string => {
...
export const renderFieldError = <T extends iFormStateLogin | iFormStateValidationIdentifyEmail | iFormValidationVerifyEmail | iFormStateValidationTask | iFormStateValidationClient>(formState: T, fieldName: keyof T): ReactNode | null => {
